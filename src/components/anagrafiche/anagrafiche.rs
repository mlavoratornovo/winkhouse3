...
use crate::components::commons::{tableview::{TableRow, PaginationInfo, TableViewData}, winkentityenum::WinkEntity};
...
pub fn Anagrafiche(cx: Scope) -> Element {
    ...
    let tabledata:TableViewData = TableViewData { datatype:WinkEntity::Anagrafiche, items: rows, pagination: pagination };
